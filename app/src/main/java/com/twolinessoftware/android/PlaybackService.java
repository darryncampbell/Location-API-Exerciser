...
import com.darryncampbell.locationapiexerciser.R;
...
public class PlaybackService extends Service implements GpxSaxParserListener {
    ...
    public static String PROVIDER_NAME = LocationManager.GPS_PROVIDER;
    //private static final String PROVIDER_NAME = LocationManager.NETWORK_PROVIDER;
    //private static final String PROVIDER_NAME = "DarrynGPS";
...
//  This is throwing an error if we stop and restart the playback (since the provider has been removed but not re-added)
...
//          mLocationManager.removeTestProvider(PROVIDER_NAME);
    ...
    private void setupTestProvider() {
        ...
        {
            Toast.makeText(this, "Device is not configured to run this app as a Mock location provider", Toast.LENGTH_LONG).show();
            broadcastError("Device is not configured to run this app as a Mock location provider");
        }
 ...
 */
    ...
    private String loadFile(String file) {
        ...
        try {
            ...
            if (file.equalsIgnoreCase("canada_highway")) {
                in_s = res.openRawResource(R.raw.canada_highway);
            }
            else if (file.equalsIgnoreCase("tasmania"))
            {
                in_s = res.openRawResource(R.raw.tasmania);
            }
            else if (file.equalsIgnoreCase("spain"))
            {
                in_s = res.openRawResource(R.raw.spain);
            }
...
*/
    ...
    private void broadcastError(String message) {
        ...
        i.putExtra(GpsPlaybackBroadcastReceiver.INTENT_ERROR, message);
        sendBroadcast(i);
    }
